...
def chamfer_distance_kdtree(points1, points2, give_id=False):
    ...
    idx_nn_12_expand = idx_nn_12.reshape(batch_size, -1, 1).expand_as(points1)
    ...
    idx_nn_21_expand = idx_nn_21.reshape(batch_size, -1, 1).expand_as(points2)
...
def fix_K_camera(K, img_size=137):
    ...
    K_new = scale_mat.reshape(1, 3, 3) @ K
    return K_new
