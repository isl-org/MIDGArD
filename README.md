...
<a href="https://pytorch.org/get-started/locally/"><img alt="PyTorch" src="https://img.shields.io/badge/PyTorch%202.6.0-ee4c2c?logo=pytorch&logoColor=white"></a>
...
```bash
git clone --recursive git@github.com:quentin-leboutet/MIDGArD.git
```
