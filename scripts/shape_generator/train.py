"""Script used to train a Shape Generator."""
...
from core.dataset.hybrid_dataset import HybridDataset
...
def main(argv) -> None:
    parser = argparse.ArgumentParser(description="Train Shape Generator.")
    parser.add_argument(
        "config_file",
